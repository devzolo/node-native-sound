...
Napi::Object NativeSound::Init(Napi::Env env, Napi::Object exports) {
  ...
  Napi::Function func = DefineClass(env, "NativeSound", {
    InstanceMethod("getBPM", &NativeSound::GetBPM),
    InstanceMethod("getBufferLength", &NativeSound::GetBufferLength),
    InstanceMethod("getEffects", &NativeSound::GetEffects),
    InstanceMethod("getFFTData", &NativeSound::GetFFTData),
    InstanceMethod("getLength", &NativeSound::GetLength),
    InstanceMethod("getLevelData", &NativeSound::GetLevelData),
    InstanceMethod("getMaxDistance", &NativeSound::GetMaxDistance),
    InstanceMethod("getMetaTags", &NativeSound::GetMetaTags),
    InstanceMethod("getMinDistance", &NativeSound::GetMinDistance),
    InstanceMethod("getPan", &NativeSound::GetPan),
    InstanceMethod("getPosition", &NativeSound::GetPosition),
    InstanceMethod("getProperties", &NativeSound::GetProperties),
    InstanceMethod("getSpeed", &NativeSound::GetSpeed),
    InstanceMethod("getVolume", &NativeSound::GetVolume),
    InstanceMethod("getWaveData", &NativeSound::GetWaveData),
    InstanceMethod("isPanningEnabled", &NativeSound::IsPanningEnabled),
    InstanceMethod("isPaused", &NativeSound::IsPaused),
    InstanceMethod("setEffectEnabled", &NativeSound::SetEffectEnabled),
    InstanceMethod("setMaxDistance", &NativeSound::SetMaxDistance),
    InstanceMethod("setMinDistance", &NativeSound::SetMinDistance),
    InstanceMethod("setPan", &NativeSound::SetPan),
    InstanceMethod("setPanningEnabled", &NativeSound::SetPanningEnabled),
    InstanceMethod("setPaused", &NativeSound::SetPaused),
    InstanceMethod("setPosition", &NativeSound::SetPosition),
    InstanceMethod("setProperties", &NativeSound::SetProperties),
    InstanceMethod("setSpeed", &NativeSound::SetSpeed),
    InstanceMethod("setVolume", &NativeSound::SetVolume),
    InstanceMethod("stop", &NativeSound::Stop)
  });
...
{
  Napi::Env env = info.Env();
  float fSampleRate; float fTempo; float fPitch; bool bReverse;
